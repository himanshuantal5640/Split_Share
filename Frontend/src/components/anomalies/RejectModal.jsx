...
const RejectModal = ({ isOpen, onClose, onSubmit, loading = false, error = null }) => {
      ...
      <div className="relative max-w-md w-full p-6 rounded-2xl border border-slate-900 bg-slate-950 shadow-2xl flex flex-col gap-5 z-10 animate-scale-up">
        <div className="flex justify-between items-center">
          <h3 className="text-xl font-bold text-white flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-red-505"></div>
            Reject Anomaly
          </h3>
          <button
            onClick={onClose}
        ...
        <p className="text-xs text-slate-400 leading-relaxed">
          Rejecting an anomaly confirms that the CSV transaction row is invalid and should be dismissed/skipped. It will not generate expenses in the database ledger. A detailed explanation note is required.
        </p>
